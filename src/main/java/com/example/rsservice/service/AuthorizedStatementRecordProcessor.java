 ...
 */
public class AuthorizedStatementRecordProcessor implements ShardRecordProcessor {

    private static final Logger log = LoggerFactory.getLogger(AuthorizedStatementRecordProcessor.class);
    ...
    public void processRecords(ProcessRecordsInput processRecordsInput) {
        ...
        try {
            ...
            processRecordsInput.records().forEach(r -> {
                ...
                log.info("StatementId: " + authorizedStatement.getStatementId() + " PUN: " + authorizedStatement.getStatementId());
